...
data = {"question": question, "message_history": message_history}
...
const data = { question: question, message_history: message_history }; // optional boolean parameter: stream: true
